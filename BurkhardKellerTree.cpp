/// Burkhard-Keller (BK) tree data structure

#include <bits/stdc++.h>
using namespace std;

#define MAXN 100 // maximum number of words in dict[]

#define TOL 2 // defines the tolerance value

#define LEN 10 // defines maximum length of a word
